...
// ANSWER: No, since the foor loop is set to only repeat an exact number of times, the length of the array will not affect the time complexity beyond the set limit.
...
// Q: Is it possible to improve this function's space complexity? If it is, write a new 
//function below.
/*ANSWER:
function getNumbersSquared(numbers) {
  let answers = []
...
// 15) Here are two functions that you came up with to count how many of each letter is in 
//a given string and return an object with the individual counts: 
...
// ANSWER: With both of the functions, the function is dependent on the size of the string that is passed in.
